...
%     \includegraphics[width=0.6\textwidth]{distribuicao_classes.png}
...
minoritária de forma mais fiel (\citeauthoronline{Davis2006},
\citeyear{Davis2006}).
...
caudas alongadas em direção aos valores máximos. Esse comportamento é esperado
em medidas morfológicas celulares, nas quais a maioria das amostras benignas
concentra valores mais baixos, enquanto os tumores malignos tendem a ocupar
as regiões de maior magnitude. Em alguns atributos, como radius\_mean e
area\_mean, é possível observar indícios de distribuição bimodal, sugerindo
que os dois grupos de classes contribuem com picos distintos para o histograma
global, um indicativo qualitativo da separabilidade entre as classes que será
explorada formalmente nas projeções UMAP e PCA da Seção~\ref{sec:umap-pca}.

% ------------------------------------------------------------------------------
\subsection{Boxplots dos Atributos}
\label{subsec:boxplots}

Complementando a análise dos histogramas, uma grade equivalente de
\textit{boxplots} foi gerada para cada um dos trinta atributos, conforme
apresentado na Figura~\ref{fig:boxplots}.
% \begin{figure}[htbp]
%     \centering
