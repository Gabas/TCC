...
LEMBRETE: CORTAR A FIGURA PARA CABER NA PÁGINA, MANTENDO APENAS OS BOXPLOTS DO GRUPO MEAN, QUE SÃO OS MAIS RELEVANTES PARA A ANÁLISE EXPLORATÓRIA. OS BOXPLOTS DOS GRUPOS SE E WORST PODEM SER APRESENTADOS EM UM APÊNDICE, COM REFERÊNCIA NA LEGENDA DA FIGURA PRINCIPAL.
...
% % TODO: Descrever as funções auxiliares padronizadas implementadas para
% % avaliação de todos os modelos:
% % — compute_stats: calcula Acurácia, Sensibilidade, Especificidade, F1,
% %   ROC-AUC e PR-AUC a partir da matriz de confusão.
% % — plot_confusion: gera heatmap anotado da matriz de confusão via Seaborn.
% % — plot_roc_pr: plota curvas ROC e Precisão-Revocação lado a lado.
% % Justificar a adoção do conjunto padronizado de métricas para garantir
% % comparabilidade entre os algoritmos avaliados.
 
% \subsection{Árvore de Decisão}
% \label{subsec:arvore-decisao}
 
% % TODO: Descrever a configuração: criterion='entropy', random_state=42.
% % Justificar o uso do ganho de informação (entropia) como critério de divisão.
% % Explicar seu papel como modelo baseline — referência de desempenho mínimo
% % esperado pelos modelos subsequentes. Apresentar os resultados obtidos
% % (relatório de classificação, importância das features, matriz de confusão
% % e curvas ROC/PR).
 
% \subsection{K-Nearest Neighbors}
% \label{subsec:knn}
 
% % TODO: Descrever a configuração: n_neighbors=20, weights='uniform'.
% % Justificar o uso de dados padronizados como requisito para o KNN, que é
% % sensível à escala dos atributos. Comentar os resultados obtidos.
 
% \subsection{Regressão Logística}
% \label{subsec:regressao-logistica}
 
% % TODO: Descrever a configuração: solver='lbfgs', max_iter=2000,
% % class_weight='balanced'. Justificar 'balanced' como correção automática
% % do desbalanceamento de classes e max_iter=2000 para garantir convergência.
% % Comentar os resultados obtidos.
 
% \subsection{Random Forest}
% \label{subsec:random-forest}
 
% % TODO: Descrever a configuração: n_estimators=500, class_weight='balanced',
% % n_jobs=-1. Justificar 500 árvores para estimativas estáveis e o paralelismo
% % total com n_jobs=-1. Indicar que este é o modelo selecionado para integração
% % com SHAP e com a aplicação, justificando com base nas métricas — em especial
% % a Sensibilidade, por ser a métrica mais crítica no contexto clínico para
% % minimização de falsos negativos. Apresentar os resultados obtidos.
 
% \subsection{Support Vector Machine}
% \label{subsec:svm}
 
% % TODO: Descrever a configuração: kernel='rbf', probability=True,
% % class_weight='balanced'. Justificar o kernel RBF para captura de fronteiras
% % não lineares e probability=True como requisito para geração das curvas
% % ROC/PR. Comentar os resultados obtidos.
