...
O Aprendizado Supervisionado é caracterizado pela presença de um "gabarito"\ nos dados de treinamento. Neste paradigma, o algoritmo recebe um conjunto de dados composto por variáveis de entrada (frequentemente chamadas de \textit{features} ou atributos) e suas respectivas variáveis de saída desejadas (os rótulos ou \textit{labels}). O objetivo do modelo é mapear a relação matemática entre as entradas e a saída, aprendendo as regras ocultas que conectam as características observadas ao resultado final.
