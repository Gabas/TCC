...
O termo câncer abrange mais de cem doenças malignas que têm como denominador comum o crescimento desordenado das células. A base biológica dessa patologia reside na perda dos mecanismos de regulação celular. Em condições normais, as células humanas seguem um ciclo rigoroso de crescimento, atuação e apoptose (morte celular programada). No entanto, quando mutações genéticas desativam esses "freios" naturais, as células passam a se multiplicar de forma caótica e ininterrupta, formando tumores com capacidade de invadir tecidos adjacentes ou sofrer metástase para órgãos distantes \cite{Inca-O-que-e-cancer}.

A velocidade de multiplicação e o grau de agressividade variam conforme o tipo da doença, que pode se originar em tecidos epiteliais, conhecidos como carcinomas (categoria na qual o câncer de mama se enquadra), ou em tecidos conjuntivos, chamados de sarcomas. A diferença fundamental entre a biologia de um tecido saudável e o desenvolvimento anômalo gerado pelas mutações pode ser observada na Figura \ref{fig:divisao_celular}.
...
https://www.gov.br/inca/pt-br/assuntos/cancer/como-surge-o-cancer: como surge o câncer (INCA).

Focar no domínio do problema, apresentando a importância do diagnóstico precoce e os desafios enfrentados pelos profissionais de saúde. Discutir a relevância da análise morfológica de células e tecidos para a classificação de tumores, destacando os principais marcadores utilizados na prática clínica. 
Citar a base de dados Breast Cancer Wisconsin como um recurso fundamental para o desenvolvimento de modelos preditivos na área.
