...
% % TODO: Escrever parágrafo introdutório situando a EDA como etapa anterior
% % ao treinamento, com objetivo de compreender a distribuição e a qualidade
% % dos dados antes de aplicar os modelos.
 
% \subsection{Estatísticas Descritivas}
% \label{subsec:estatisticas-descritivas}
 
% % TODO: Descrever a aplicação de info() e describe() para inspecionar tipos,
% % contagem de não-nulos e distribuição estatística das 30 features (mínimo,
% % máximo, média, desvio padrão, quartis). Comentar os resultados mais
% % relevantes encontrados.
 
% \subsection{Distribuição das Classes}
% \label{subsec:distribuicao-classes}
 
% % TODO: Descrever o gráfico de barras (countplot) confirmando o leve
% % desbalanceamento: 357 benignos (62,7%) versus 212 malignos (37,3%).
% % Discutir a implicação desse desbalanceamento para a escolha de métricas
% % como PR-AUC em vez de depender exclusivamente da acurácia.
 
% \subsection{Histogramas dos Atributos}
% \label{subsec:histogramas}
 
% % TODO: Descrever a grade 6×5 com histograma de cada uma das 30 variáveis
% % numéricas (20 bins), permitindo identificar assimetrias, concentrações e
% % possíveis distribuições bimodais ligadas à separação de classes.
 
% \subsection{Boxplots dos Atributos}
% \label{subsec:boxplots}
 
% % TODO: Descrever a grade 6×5 de boxplots para visualização de dispersão
% % e outliers em cada variável. Comentar os atributos que apresentaram
% % maior concentração de valores extremos e o que isso indica clinicamente.
